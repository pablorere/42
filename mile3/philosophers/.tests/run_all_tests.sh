...
chmod +x "$SCRIPT_DIR/test_edge_cases.sh" "$SCRIPT_DIR/test_mandatory.sh" "$SCRIPT_DIR/count_meals.sh" "$SCRIPT_DIR/stress_test.sh" 2>/dev/null
...
echo ""
run_suite "EDGE CASES & ERROR HANDLING" "$SCRIPT_DIR/test_edge_cases.sh"
edge_result=$?
...
run_suite "MANDATORY TEST CASES" "$SCRIPT_DIR/test_mandatory.sh"
mandatory_result=$?
...
bash "$SCRIPT_DIR/count_meals.sh" 5 800 200 200 7
echo ""

echo -e "${BLUE}Example 2: Single philosopher (should die)${NC}"
bash "$SCRIPT_DIR/count_meals.sh" 1 800 200 200
echo ""

echo -e "${BLUE}Example 3: Two philosophers${NC}"
bash "$SCRIPT_DIR/count_meals.sh" 2 800 200 200
echo ""
...
bash "$SCRIPT_DIR/stress_test.sh" 10 "5 800 200 200 7"
stress1=$?
echo ""

echo -e "${BLUE}Stress Test 2: Tight timing (10 runs)${NC}"
bash "$SCRIPT_DIR/stress_test.sh" 10 "4 410 200 200"
stress2=$?
echo ""

echo -e "${BLUE}Stress Test 3: Two philosophers (20 runs)${NC}"
bash "$SCRIPT_DIR/stress_test.sh" 20 "2 800 200 200"
stress3=$?
echo ""
